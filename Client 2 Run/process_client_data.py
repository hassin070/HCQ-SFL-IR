...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default=r"G:\Research\Split Fed Quantum ML\Datasets\Paper DATACLIENT 2\Client2",
        help="Path to folder containing raw CSV.GZ files"
    )
    parser.add_argument(
        "--output_file", type=str, default="processed_client_data.csv",
        help="Path to save the processed CSV or Parquet file (default: processed_client_data.csv)"
    )

    args = parser.parse_args()
    print(f"Using input_folder={args.input_folder}")
    print(f"Using output_file={args.output_file}")
